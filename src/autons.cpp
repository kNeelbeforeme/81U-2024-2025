...
void blue_goal_rush() {
  ...
  chassis.pid_drive_set(29, 110, true);
  chassis.pid_wait();
  ...
  chassis.pid_turn_set(265, TURN_SPEED);
  chassis.pid_wait();
...
void red_ring_rush() {
  ...
  chassis.pid_swing_set(RIGHT_SWING, -315, SWING_SPEED);
  chassis.pid_wait();
...
void red_goal_rush() {
  ...
  chassis.pid_swing_set(RIGHT_SWING, -45, SWING_SPEED);
  chassis.pid_wait_until(-43);
  chassis.pid_swing_set(LEFT_SWING, -15, SWING_SPEED);
  chassis.pid_wait_until(-16);
...
void new_skills_right() {
  ...
  chassis.pid_swing_set(LEFT_SWING, 25.5_deg, TURN_SPEED, 0, true);
  chassis.pid_wait_quick();
...
void new_skills_left() {
  ...
  chassis.pid_drive_set(-30, SLOW_DRIVE_SPEED, true);
  chassis.pid_wait_quick();
  ...
  chassis.pid_swing_set(RIGHT_SWING, -27, TURN_SPEED, 0, true);
  chassis.pid_wait_quick();
...
void new_skills_blueside() {
  ...
  chassis.pid_drive_set(44, SLOW_DRIVE_SPEED, true);
  ...
  chassis.pid_drive_set(-24, SLOW_DRIVE_SPEED, true);
  chassis.pid_wait_until(-20);
  backClamp.set(true);
  intake.move(120);
  ...
  chassis.pid_drive_set(-110, 110, true);
  // lb_setState(3);
  chassis.pid_wait_quick();

  chassis.pid_drive_set(50, 110, true);
  chassis.pid_wait_quick_chain();
}
void skills_code() {
  chassis.drive_angle_set(0);
